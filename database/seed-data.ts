...
export const initialData: SeedData = {
    ...
    products: [
        {
            description: "Ropa para hombre espectacular.",
            images: [
                './fulldetord/shirt1.jpeg',
                './fulldetord/hombre2.jpeg',
            ],
            inStock: 7,
            price: 75,
            ...
            type: 'shirts',
            tags: ['sweatshirt'],
            title: "Mens's Oversizes Tshirts",
            gender: 'men'
        },
        {
            description: "Ropa para hombre espectacular.",
            images: [
                './fulldetord/hombre1.jpeg',
                './fulldetord/hombre2.jpeg',
            ],
            inStock: 7,
            price: 75,
            sizes: ['XS','S','M','L','XL','XXL'],
            slug: "mens_chill_hombre1_neck_sweatshirt",
            type: 'shirts',
            tags: ['sweatshirt'],
            title: "Mens's Oversizes Tshirts",
            gender: 'men'
        },
        {
            description: "Ropa para hombre espectacular.",
            images: [
                './fulldetord/hombre3.jpeg',
                './fulldetord/shirt1.jpeg',
            ],
            inStock: 7,
            price: 75,
            sizes: ['XS','S','M','L','XL','XXL'],
            slug: "mens_chill_hombre3_neck_sweatshirt",
            type: 'shirts',
            tags: ['sweatshirt'],
            title: "Mens's Oversizes Tshirts",
            gender: 'men'
        ...
        {
            description: "Ropa unisex espectacular.",
            images: [
                './fulldetord/gorra1.jpeg',
                './fulldetord/gorra2.jpeg'
            ],
            inStock: 10,
            price: 130,
            sizes: ['S','M','L','XL','XXL'],
        ...
        {
            description: "The Women's Tshirts.",
            images: [
                './fulldetord/mujer1_1.jpeg',
                './fulldetord/mujer1.jpeg',
            ],
            inStock: 85,
            price: 225,
            sizes: ['XS','S','M'],
        ...
        {
            description: "The Women's Jackets.",
            images: [
                './fulldetord/pantalon1.jpeg',
                './fulldetord/pantalon2.jpeg',
            ],
            inStock: 10,
            price: 130,
            sizes: ['XS','S','M','XXL'],
        ...
        },
        {
            ...
            price: 110,
            sizes: ['XS','S','M','L','XL','XXL'],
            slug: "women_jacket_slouchy_crew_sweatshirt",
            type: 'hoodies',
            tags: ['hoodie'],
            title: "Women's Jackets",
            gender: 'women'
